...
- **Event details (live copy):** invitation date/time updated to **19 September 2026, 15:30**; destination switched to restaurant **"НАЛ"** (Советская ул., 1, село Большие Салы).
